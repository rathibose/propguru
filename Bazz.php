...
xmlhttp.open("GET","ajax_bazz.php?from="+from+"&to="+to,true);
xmlhttp.send();
}  
</script>
</head><body>
<form name="numdisplay" id="numdisplay" method="get">
  <table style="text-align: center; width: 604px; height: 149px;" border="1" cellpadding="2" cellspacing="2" align="center">
    <tbody>
      <tr>
